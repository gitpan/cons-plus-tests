...
# $Id: t0146.t,v 1.4 2000/06/01 22:00:50 knight Exp $
...
$workpath_repository_install_foo_pl = $test->workpath('repository', 'install', 'foo.pl');
...
$test->execute(prog => $workpath_repository_install_foo_pl, interpreter => $^X, stdout => <<_EOF_);
repository/foo.pl called with arg 0 = '\Q$workpath_repository_install_foo_pl\E'
_EOF_
...
\$env = new cons ( ${\$test->cons_env} );
Install_Local \$env 'install', 'foo.pl';
_EOF_
