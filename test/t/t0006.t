...
# $Id: t0006.t,v 1.3 2000/06/01 22:00:44 knight Exp $
...
$test = Test::Cmd::Cons->new(string => 'absolute (/) path name');
...
$workpath_xxx_bbb_c = $test->workpath('xxx', 'bbb.c');
...
$test->write($workpath_xxx_bbb_c, <<'_EOF_');
void
bbb(void)
{
	printf("xxx/bbb.c\n");
