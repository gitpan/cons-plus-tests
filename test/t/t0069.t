...
# $Id: t0069.t,v 1.3 2000/06/01 22:00:45 knight Exp $
...
$test = Test::Cmd::Cons->new(string => 'CPPPATH array reference %-expansion');
...
\$env_hash{MY_INC} = 'include';
\$env_hash{CPPPATH} = [ '%MY_INC' ];
