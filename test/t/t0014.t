...
# $Id: t0014.t,v 1.3 2000/06/01 22:00:44 knight Exp $
...
$test = Test::Cmd::Cons->new(string => 'CPPPATH');

$test->subdir('include', 'zark');

#
$foo_exe = "foo$_exe";
$include_foo_h = $test->catfile('include', 'foo.h');
$zark_foo_h = $test->catfile('zark', 'foo.h');
...
$test->write($include_foo_h, <<'_EOF_');
#define	STRING	"include/foo.h\n"
_EOF_

$test->write($zark_foo_h, <<'_EOF_');
#define	STRING	"zark/foo.h\n"
_EOF_
